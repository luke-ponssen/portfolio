...
// const donutTexture = new THREE.TextureLoader().load('../src/images/donut.jpg');
// const normalDonutTexture = new THREE.TextureLoader().load('../src/images/normal.jpg');
...
// // Add a project
// const proj1Texture = new THREE.TextureLoader().load('../src/images/bellwether.jpg');
...
// // Add a project
// const proj2Texture = new THREE.TextureLoader().load('../src/images/consulting.jpg');
...
// // Add a project
// const proj3Texture = new THREE.TextureLoader().load('../src/images/exoplanet.jpg');
...
// // Add a project
// const proj4Texture = new THREE.TextureLoader().load('../src/images/videogame.jpg');
...
// // Add a project
// const proj5Texture = new THREE.TextureLoader().load('../src/images/web.jpg');
...
// // Add a jeffCube
// const jeffTexture = new THREE.TextureLoader().load('../src/images/jeff.png');
